...
<body>
    <div class="d-flex justify-content-between b-0 fixed-top header">
        ...
        <div class="dropdown show mt-3 mb-2 mr-4 ">
            ...
            <div class="dropdown-menu mt-3 px-2 " aria-labelledby="dropdownMenuLink">
                ...
                <a href="{{route('logout')}}" class="dropdown-item" href="#">Log Out</a>
            </div>
        </div>
    </div>
    <div class="row no-gutters rightSide mt-4 pt-1">
        <div class="col-sm-2 d-md-block d-none bg-info leftSide ">
            ...
            <div class="list-group ">
                ...
                <div class="collapse" id="HRMenu">
                    <a class="btn text-white bg-secondary form-control " href="{{ route('employees') }}">Employees</a>
                    <a class="btn text-white bg-secondary form-control " href="{{ route('leave') }}">Leave</a>
                    <a class="btn text-white bg-secondary form-control " href="{{ route('dept') }}">Department</a>
                    <a class="btn text-white bg-secondary form-control " href="{{ route('desg') }}">Designation</a>
                    <a class="btn text-white bg-secondary form-control " href="{{ route('reset_password') }}">Reset
                        Password</a>
                    {{-- <a class="btn text-white bg-secondary form-control " href="#">Duty Roster</a> --}}
                </div>
                <button class="list-group-item list-group-item-active border-0 text-white bg-info "
                    data-toggle="collapse" href="#ReportMenu">Reports</button>
                <div class="collapse" id="ReportMenu">
                    {{-- <a class="btn text-white bg-secondary form-control " href="{{ route('my_attendance') }}">My Attendance</a>
                    <a class="btn text-white bg-secondary form-control " href="{{ route('my_machine') }}">My Machine Log</a> --}}
                    <a class="btn text-white bg-secondary form-control " href="{{ route('attendance') }}">Attendance Detail</a>
                    {{-- <a class="btn text-white bg-secondary form-control " href="{{ route('staff_attendance') }}">Staff Attendance Detail</a> --}}
