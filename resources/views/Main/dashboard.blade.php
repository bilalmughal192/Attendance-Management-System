        ...
        <div class="row no-gutters mx-2 mt-2 ">
            <div class="col-lg-7 col-sm-12 py-2 px-3 empDetail border-bottom  ">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-3 col-6 mb-2">
                        <p class="display-4" id="empID">{{ auth()->user()->user_id }}</p>
                        <p class="display-4" id="empName">{{ auth()->user()->name }}</p>
                        <p class="display-4" id="empPh">{{ auth()->user()->ph }}</p>
                        <p class="display-4" id="empDesignatio">{{ auth()->user()->desg_name }}</p>
                    </div>
                    ...
                    <div class="col-md-3 col-6">
                        <p class="display-4" id="empDOJ"> {{ date('d M Y', strtotime(auth()->user()->doj)) }}</p>
                        <p class="display-4" id="empFatherName">{{ auth()->user()->father_name }}</p>
                        <p class="display-4" id="empEmail">{{ auth()->user()->email }}</p>
                        <p class="display-4" id="empDept">{{ auth()->user()->dept_name }}</p>
                    </div>
                </div>
