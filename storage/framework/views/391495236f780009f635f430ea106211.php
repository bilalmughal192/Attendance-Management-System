...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e('/favicon.png'); ?>" type="image/x-icon">
        ...
        <link rel="stylesheet" href="<?php echo e(asset('/style/bootstrap.css')); ?>">
    ...
    <div class="d-flex justify-content-between b-0 fixed-top header">
        ...
        <div class="dropdown show mt-3 mb-2 mr-4 ">
            ...
            <div class="dropdown-menu mt-3 px-2 " aria-labelledby="dropdownMenuLink">
                ...
                <a href="<?php echo e(route('logout')); ?>" class="dropdown-item" href="#">Log Out</a>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-2 d-md-block d-none bg-info leftSide ">
            ...
            <div class="list-group ">
                ...
                <div class="collapse" id="HRMenu">
                    ...
                    <a class="btn text-white bg-secondary form-control " href="<?php echo e(route('reset_password')); ?>">Reset
                        Password</a>
                ...
                <div class="collapse" id="ReportMenu">
                    ...
                    <a class="btn text-white bg-secondary form-control " href="<?php echo e(route('attendance')); ?>">Attendance Detail</a>
...
<?php /**PATH C:\xampp\htdocs\AMS-21\resources\views/Main/master.blade.php ENDPATH**/ ?>