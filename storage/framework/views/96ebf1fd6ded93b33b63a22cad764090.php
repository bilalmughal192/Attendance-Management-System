        ...
        <div class="col-sm-2 d-md-block d-none bg-info leftSide ">
            ...
            <div class="list-group ">
                ...
                <div class="collapse" id="ReportMenu">
                    <a class="btn text-white bg-secondary form-control " href="<?php echo e(route('my_attendance')); ?>">My Attendance</a>
                    <a class="btn text-white bg-secondary form-control " href="<?php echo e(route('my_machine')); ?>">My Machine Log</a>
