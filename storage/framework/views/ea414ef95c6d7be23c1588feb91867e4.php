                    ...
                    <form action="<?php echo e(route('save_user')); ?>" method="POST">
                        ...
                        <select name="user_id" class="form-control mr-2 mb-2" required>
                            ...
                            <?php $__currentLoopData = $emp_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($emp->user_id); ?>"><?php echo e('('.$emp->user_id.') '. $emp->name); ?></option>
...
<?php echo $__env->make('Main.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AMS-21\resources\views/HMS/reset_password.blade.php ENDPATH**/ ?>